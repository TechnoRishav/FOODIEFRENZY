...
import Sarnadip from './Sarnadip.jpg';
import Rishav2 from './Rishav2.jpg';
import Sangini from './Sangini.jpg';
...
export const teamMembers = [
    {
        ...
        social: {
            ...
            instagram: "https://www.instagram.com/sanginimaiti?igsh=bXc5N3lmMjB0OTlq",
            facebook: "https://www.facebook.com/share/18macWZB3P/",
            linkedin: "https://www.linkedin.com/in/sangini-maiti-a66244291?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
        },
    },
    {
        name: "Rishav Taral",
        role: "Backend Chef",
        img: Rishav2,
        bio: "Backend Developer | Server, Database, API",
        delay: 0.3,
        social: {
            twitter: "https://x.com/RishavTaral?t=WJfe-1CBKMClOdlNJBmnaA&s=08",
            instagram: "https://www.instagram.com/techno_rishav_04?utm_source=qr&igsh=eHBrYnJrcWNucHNr",
            facebook: "https://www.facebook.com/share/1DrgZnr18j/",
            linkedin: "https://www.linkedin.com/in/rishav-taral-16837a247/",
        },
    },
    {
        name: "Sarnadip Chandra",
        role: "Payment Chef",
        img: Sarnadip,
        bio: "Payments & Integration | Deployment & Testing",
        delay: 0.1,
        social: {
            twitter: "https://x.com/MR_ALEXWAR",
            instagram: "https://www.instagram.com/swarna_2004?igsh=MTAyOXl2djQza3BpYg==",
...
export const socialIcons = [
    { icon: FaFacebook, link: 'https://www.facebook.com/share/1DrgZnr18j/', color: '#3b5998', label: 'Facebook' },
    { icon: FaInstagram, link: 'https://www.instagram.com/techno_rishav_04?utm_source=qr&igsh=eHBrYnJrcWNucHNr', color: '#E1306C', label: 'Instagram' },
    { icon: FaXTwitter, link: 'https://x.com/RishavTaral?t=WJfe-1CBKMClOdlNJBmnaA&s=08', color: '#000', label: 'X' },
    { icon: FaYoutube, link: 'https://youtube.com/@technorishav2004?si=b0qfUnbEQ-cYK9X8', color: '#FF0000', label: 'Youtube' },
];
