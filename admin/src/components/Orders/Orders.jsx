...
const Orders = () => {
    ...
    const fetchOrders = async () => {
      try {
        const response = await axios.get(
          'https://foodiefrenzy-backend-1h1g.onrender.com/api/orders/getall',
          {
  ...
  const handleStatusChange = async (orderId, newStatus) => {
    try {
      await axios.put(`https://foodiefrenzy-backend-1h1g.onrender.com/api/orders/getall/${orderId}`, { status: newStatus });
